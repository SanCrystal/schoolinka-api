...
import { IsString, validate, IsArray, IsOptional, IsNotEmpty, IsEmail, MaxLength, MinLength, IsInt, IsUUID } from 'class-validator';
export class User {
}
__decorate([
