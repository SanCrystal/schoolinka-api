...
export const getUserByID = async (
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: "User was fetched successfully", data: user });
  } catch (error) {
    return res
      .status(500)
      .json({ message: "Internal Server Error " + error.message });
...
export const updateUserByID = async (
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: "User was updated successfully", data: userUpdate });
  } catch (error) {
    return res
      .status(500)
      .json({ message: "Internal Server Error " + error.message });
...
export const deleteUserByID = async (
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: "User was deleted successfully", data: user });
  } catch (error) {
    return res
      .status(500)
      .json({ message: "Internal Server Error " + error.message });
